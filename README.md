...
このアプリケーションは、オンライン上でオリジナルのカードゲームを楽しむために開発されました。もともと、友人とビデオ通話を通じて紙のカードゲームをオンラインで楽しんでいた際に、物理的な制約や操作の不便さを感じたことがきっかけです。そこで、よりスムーズかつ自由度の高いオンライン環境でカードゲームが楽しめるツールが必要だと考え、本アプリケーションの開発に着手しました。  
本アプリケーションでは、ユーザー自身がオリジナルのカードやルールを作成し、それらを基に自由な対戦が行えるよう設計されています。これにより、既存の枠にとらわれない新しいゲーム体験や、自分だけのオリジナルカードゲームを簡単に楽しむことができます。
